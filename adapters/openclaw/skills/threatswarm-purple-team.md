...
Purple team operations — MITRE ATT&CK mapping, detection gap identification, offensive technique execution with defensive validation, atomic red team tests, and collaborative attacker/defender exercises.

## Tags
collaborative, offensive, defensive, MITRE

## Triggers
purple team, MITRE ATT&CK, detection gap, atomic red team, attack validation, purple exercise
