...
Vulnerability management — Nuclei template scanning, authenticated scanning, Nessus/Tenable integration, vulnerability prioritization, CVSS scoring, and remediation tracking.

## Tags
defensive, compliance, vulnerability-management

## Triggers
vulnerability management, Nuclei, Nessus, vuln scanning, CVSS, remediation, vulnerability prioritization
