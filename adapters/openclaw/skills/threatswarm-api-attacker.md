...
API security testing — REST/GraphQL/SOAP testing, IDOR, BOLA/BFLA, broken authentication, rate limiting bypass, mass assignment, API key leakage, and API schema fuzzing.

## Tags
offensive, web, API, appsec

## Triggers
API security, REST API, GraphQL, IDOR, BOLA, API key, mass assignment, rate limit, API testing
