...
Cloud penetration testing — AWS, Azure, GCP enumeration, Pacu automation, S3 bucket exploitation, IAM privilege escalation, Lambda backdoor injection, and cloud metadata service abuse.

## Tags
offensive, cloud, AWS, Azure, GCP

## Triggers
cloud security, AWS, Azure, GCP, Pacu, S3 bucket, IAM, Lambda, cloud pentest, metadata service
