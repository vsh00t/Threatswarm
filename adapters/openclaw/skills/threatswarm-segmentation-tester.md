...
Network segmentation testing — cross-segment access validation, firewall rule testing, VLAN hopping verification, lateral movement path identification, and segmentation gap detection.

## Tags
offensive, network, infrastructure

## Triggers
segmentation, network segmentation, firewall rules, cross-segment, VLAN, lateral movement, network isolation
