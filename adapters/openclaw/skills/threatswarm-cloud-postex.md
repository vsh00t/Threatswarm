...
Cloud post-exploitation — IAM persistence, data exfiltration from cloud storage, cross-account trust abuse, cloud instance metadata SSRF, and cloud audit log manipulation.

## Tags
offensive, cloud, post-exploitation, persistence

## Triggers
cloud post-exploitation, cloud persistence, IAM abuse, cloud data exfil, cloud audit, cross-account
